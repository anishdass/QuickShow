...
const TrailerSection = () => {
  const [currentMovie, setCurrentMovie] = useState(dummyTrailers[0]);
  const [otherMovies, setOtherMovies] = useState(dummyTrailers.slice(1));
